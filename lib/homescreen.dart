    ...
    pd.Page(
      ...
      build: (context) {
        ...
        return pd.Column(
          ...
          children: [
            pd.Text("Bridal Studio",style: pd.TextStyle(fontSize: 30)),
            pd.SizedBox(height: 20),
            pd.Text("Marriage Shopping",style: pd.TextStyle(fontSize: 20)),
            pd.SizedBox(height: 15),
            pd.Text("NAME: Meshva Patel",style: pd.TextStyle(fontSize: 15)),
            pd.SizedBox(height: 10),
            pd.Text("Mobile: 9313220217",style: pd.TextStyle(fontSize: 15)),
            pd.SizedBox(height: 10),
